...
# ==================== 代理配置 ====================
# HTTP代理，用于常规请求
# 设置为 None 或空字符串表示不使用代理
# 示例：
# - 使用代理: PROXY_URL = "http://127.0.0.1:7890"
# - 不用代理: PROXY_URL = None 或 PROXY_URL = ""
...
OPENAI_COMPAT_HOST = "0.0.0.0"  # Docker 环境需要 0.0.0.0
OPENAI_COMPAT_PORT = 5012
